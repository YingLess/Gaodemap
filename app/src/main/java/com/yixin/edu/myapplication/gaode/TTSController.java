...
//        SpeechUtility.createUtility(mContext, SpeechConstant.APPID + "=55bc62c7");
		SpeechUtility.createUtility(mContext, SpeechConstant.APPID + "=5cbd5d8f");

        // 初始化合成对象.
//        mSpeechSynthesizer = SpeechSynthesizer.createSynthesizer(mContext, null);
        mSpeechSynthesizer = SpeechSynthesizer.createSynthesizer(MapsApplication.getAppContext(), null);
