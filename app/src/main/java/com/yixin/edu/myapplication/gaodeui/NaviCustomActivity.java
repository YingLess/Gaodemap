...
import com.yixin.edu.myapplication.gaode.NaviSetting;
...
public class NaviCustomActivity extends BaseActivity implements
    ...
    public void onResume() {
        ...
        super.onResume();
        setAmapNaviViewOptions();
//        TTSController.getInstance(getApplicationContext()).playText("你妹的，不对啊");
    ...
    public void onPause() {
        ...
        super.onPause();
        TTSController.getInstance(getApplicationContext()).playText("高德持续为您导航");
...
//        intent.setClass(NaviCustomActivity.this, HaActivity.class);
//        startActivity(intent);
    }
