        ...
        mLocationManagerProxy.requestLocationData(
                LocationProviderProxy.AMapNetwork, 2000, 15, new AMapLocationListener() {
                    ...
                    public void onLocationChanged(AMapLocation aMapLocation) {
                        ...
                        Toast.makeText(MapsApplication.getAppContext(),"mCurrentLatLng.latitude1" + mCurrentLatLng.latitude,  Toast.LENGTH_SHORT).show();
                        Toast.makeText(MapsApplication.getAppContext(),"mCurrentLatLng.latitude2" + mCurrentLatLng.longitude,  Toast.LENGTH_SHORT).show();
                    }
